---
title: "Observabilidad de Costos"
description: "s2s registra uso y costo LLM por proyecto, capturando tokens, costo en USD y estado de presupuesto para cada operación de etapa."
---

s2s registra uso y costo LLM por proyecto en:
...
Comportamiento:
- warning al alcanzar el umbral de advertencia
