---
title: "Flujo de Trabajo Chat-Native"
description: "En modo chat-native, s2s orquesta clasificación de intent, enrutamiento, estado y calidad sin gastar tokens LLM en decisiones de orquestación."
---
