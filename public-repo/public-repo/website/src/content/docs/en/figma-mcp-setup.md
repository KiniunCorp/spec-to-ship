...
description: "Connect a Figma file to s2s via MCP so the design stage can create and read frames directly from your Figma account."
---
...
4. Give it a descriptive name (e.g., "s2s")
5. Copy the token
...
When s2s's design stage runs, Claude Code will:
