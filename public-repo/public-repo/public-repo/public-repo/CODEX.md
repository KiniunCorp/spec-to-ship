...
# SpecToShip Repository Adapter For Codex

This file is the Codex-specific adapter for developing the `spec-to-ship` source repository.
...
6. Keep `CODEX.md` aligned with `AGENTS.md`.

<!-- S2S_INTERNAL_GOVERNANCE_START -->
# S2S Internal Codex Adapter (Repo)
