# Guía de Backup y Restore Spec-To-Ship (ES)
...
4. `s2s` también crea snapshots automáticos pre-policy cuando se aplican decisiones de discrepancias en init/config.
