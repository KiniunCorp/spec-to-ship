...
# SpecToShip Repository Adapter For Claude

This file is the Claude-specific adapter for developing the `spec-to-ship` source repository.
...
6. Keep `CLAUDE.md` aligned with `AGENTS.md`.

<!-- S2S_INTERNAL_GOVERNANCE_START -->
# S2S Internal Claude Adapter (Repo)

For Claude sessions in this repository:
...
- Use `internal/self-host/change-classification_en.md` to distinguish product work from repo governance work.
