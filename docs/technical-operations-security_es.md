# Operación Técnica y Seguridad Spec-To-Ship (ES)
...
3. Mantener allowlist de comandos mínima.
...
7. Forzar seguridad de rama antes de push: si la rama actual está ligada a PR(s) cerrados/mergeados, cambiar a rama nueva y abrir PR nuevo.
